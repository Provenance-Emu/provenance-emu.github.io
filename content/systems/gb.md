---
title: "Play Game Boy Games on iPhone | Provenance"
date: 2024-03-05
description: "Game Boy emulator for iOS — play original Game Boy and Game Boy Color games on iPhone, iPad, and Apple TV with Provenance."
system: "Game Boy"
shortName: "GB / DMG"
...
- **Shader Support** — Apply a classic green-tinted DMG palette filter or CRT-style effects to nail the original handheld aesthetic
- **Cheat Codes** — Game Genie and GameShark code support for Game Boy titles
- **Fast Forward** — Speed through slow text sequences or random encounters
- **On-Screen Controls** — Customizable touch overlay for playing without a physical controller

## iCloud Sync with Provenance Plus

[Provenance Plus](/plus/) adds iCloud sync for your Game Boy save states and game library. Your Pokémon save files and Link's Awakening progress stay backed up and available across all your devices automatically.
