---
title: "Play PlayStation 1 Games on iPhone & iPad | Provenance"
date: 2024-03-05
description: "PlayStation emulator for iOS — play PS1 and PSX games on iPhone, iPad, and Apple TV with Provenance. Free, open-source, supports disc-based PS1 titles."
system: "PlayStation"
shortName: "PS1 / PSX"
...
- `.img` — Alternate disc image format
...
- **Save States** — Save anywhere, not just at in-game memory card screens
- **Memory Card Emulation** — Virtual memory card support for games that use the PS1's built-in save system
- **Controller Support** — Full DualShock-style analog support via MFi, Xbox, and PlayStation controllers; on-screen controls for touchscreen play
- **Shader Support** — Apply CRT filters to replicate the visual style of original PlayStation hardware
- **Cheat Codes** — GameShark code support for PS1 titles
- **Fast Forward** — Skip cutscenes or accelerate through slower sections

## iCloud Sync with Provenance Plus

[Provenance Plus](/plus/) adds iCloud sync for your PlayStation save states, so your progress on a long RPG is automatically backed up and available across all your devices.
