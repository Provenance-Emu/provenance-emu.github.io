---
title: "Play PSP Games on iPhone & iPad | Provenance"
date: 2024-03-05
description: "PSP emulator for iOS — play PlayStation Portable games on iPhone, iPad, and Apple TV with Provenance."
...
- `.pbp` — PlayStation Portable executable package format, used for digital and download releases

CSO compression is a practical choice for PSP games, which tend to be large and benefit from the space savings on mobile storage.
...
- **Shader Support** — Visual filters and upscaling options to enhance PSP graphics on modern high-resolution displays
- **Cheat Codes** — Cheat code support for PSP titles
- **Fast Forward** — Speed through cutscenes or slower segments
- **On-Screen Controls** — Customizable touch overlay for playing without a physical controller

## iCloud Sync with Provenance Plus

[Provenance Plus](/plus/) adds iCloud sync for your PSP save states and game library. Whether you're deep into a Monster Hunter campaign or midway through a Crisis Core playthrough, Plus keeps your progress synced across every device automatically.
